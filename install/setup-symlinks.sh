...
#ln -sf ~/.dotfiles/config/udev-rules/95-hdmi-plug.rules /etc/udev/rules.d/95-hdmi-plug.rules
#sudo ln -sf ~/.dotfiles/config/40-libinput.conf /usr/share/X11/xorg.conf.d/40-libinput.conf
#sudo ln -sf ~/.dotfiles/config/keycodes /usr/share/X11/xkb/keycodes/evdev
